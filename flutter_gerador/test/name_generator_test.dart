...
void main() {
  group('NameGenerator v7.6.133 - Validação', () {
    ...
    test('Português gera lista de nomes válida', () {
      final nameList = NameGenerator.generateNameList('Português', seedLetter: 'L');
    ...
    test('English gera lista de nomes válida', () {
      final nameList = NameGenerator.generateNameList('English', seedLetter: 'M');
    ...
    test('Español gera lista de nomes válida', () {
      final nameList = NameGenerator.generateNameList('Español', seedLetter: 'R');
    ...
    test('Français gera lista de nomes válida', () {
      final nameList = NameGenerator.generateNameList('Français', seedLetter: 'P');
    ...
    test('Seeds diferentes geram nomes diferentes', () {
      final listA = NameGenerator.generateNameList('Português', seedLetter: 'A');
      final listL = NameGenerator.generateNameList('Português', seedLetter: 'L');
      final listR = NameGenerator.generateNameList('Português', seedLetter: 'R');
    ...
    test('Gera 12+ nomes por seed', () {
      final nameList = NameGenerator.generateNameList('Português', seedLetter: 'G');
      
      // Contar quantos nomes aparecem (cada nome em uma linha)
      final lines = nameList.split('\n').where((line) => 
