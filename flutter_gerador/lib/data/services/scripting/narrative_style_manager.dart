...
/// 🎨 NarrativeStyleManager - Gerencia estilos narrativos para geração de scripts
///
/// Responsabilidades:
/// - Fornecer orientações de estilo narrativo baseadas na configuração
/// - Detectar anacronismos baseados em período histórico
/// - Fornecer elementos de época apropriados
///
...
class NarrativeStyleManager {
  ...
  static String getStyleGuidance(ScriptConfig config) {
    final style = config.narrativeStyle;

    switch (style) {
      case 'reflexivo_memorias':
        return _getReflexivoMemoriasGuidance();

      case 'epico_periodo':
        return _getEpicoPeriodoGuidance(config);

      case 'educativo_curioso':
        return _getEducativoCuriosoGuidance();

      case 'acao_rapida':
        return _getAcaoRapidaGuidance();

      case 'lirico_poetico':
        return _getLiricoPoeticoGuidance();

      default: // ficcional_livre
        return _getFiccionalLivreGuidance();
    }
  }

  static String _getReflexivoMemoriasGuidance() {
    return '''
════════════════════════════════════════════════════════════════
...
''';
  ...
  static String _getEpicoPeriodoGuidance(ScriptConfig config) {
...
**⚠️ ANACRONISMOS A EVITAR (Não existiam em $year):**
...
''';
  ...
  static String _getEducativoCuriosoGuidance() {
    return '''
════════════════════════════════════════════════════════════════
...
''';
  ...
  static String _getAcaoRapidaGuidance() {
    return '''
════════════════════════════════════════════════════════════════
...
''';
  ...
  static String _getLiricoPoeticoGuidance() {
    return '''
════════════════════════════════════════════════════════════════
...
''';
  ...
  static String _getFiccionalLivreGuidance() {
    return '''
════════════════════════════════════════════════════════════════
