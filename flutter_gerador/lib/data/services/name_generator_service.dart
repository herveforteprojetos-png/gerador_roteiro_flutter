...
class NameGeneratorService {
  ...
  _namesDatabase = {
    ...
    'ko': {
      // COREANO - NOMES AUTÊNTICOS COREANOS (EXPANDIDO v7.6.40)
      'masculino': {
        'jovem': [
          // Nomes populares modernos
          'Min-jun',
          'Seo-jun',
          'Do-yoon',
          'Si-woo',
  ...
  // 🇰🇷 SOBRENOMES COREANOS - Top 100 sobrenomes mais comuns na Coreia
  // Baseado em dados do censo coreano - cobertura de ~85% da população
  // v7.6.43: Formato Map com romanização e hangul
  static const Map<String, String> _koreanSurnames = {
    // TOP 10 - Mais de 50% da população
    'Kim': '김',    // 21.5%
    'Lee': '이',    // 14.7%
    'Park': '박',   // 8.4%
    'Choi': '최',   // 4.7%
  ...
  // 🇰🇷 NOMES COREANOS EM HANGUL - Mapeamento romanização → 한글
  // v7.6.43: Adiciona versão em hangul dos nomes para TTS e autenticidade
  static const Map<String, String> _koreanNamesHangul = {
    // Masculino - Jovem/Popular
    'Min-jun': '민준',
    'Seo-jun': '서준',
    'Do-yoon': '도윤',
    'Si-woo': '시우',
  ...
  static String generateName({
    ...
    // 🇰🇷 COREANO: Adicionar sobrenome (formato: Sobrenome Nome-pessoal)
    // v7.6.43: Agora inclui versão em Hangul (한글)
    String finalName = selectedName;
    if (language == 'ko') {
      final surnameKeys = _koreanSurnames.keys.toList();
      final randomSurnameRoman = surnameKeys[random.nextInt(surnameKeys.length)];
      final randomSurnameHangul = _koreanSurnames[randomSurnameRoman]!;
      
      // Obter versão hangul do nome (se disponível)
      final nameHangul = _koreanNamesHangul[selectedName] ?? selectedName;
      
      // Formato: "Romanização (한글)"
      finalName = '$randomSurnameRoman $selectedName ($randomSurnameHangul$nameHangul)';
      print('🇰🇷 NOME COREANO COMPLETO: $finalName');
    }
    ...
    print(
      '✅ NOME SELECIONADO: $finalName (${availableNames.length} disponíveis)',
    );
